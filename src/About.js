  ...
  return (
    <Container className="mt-4">
      ...
      <Row>
        <Col md={12}>
          <p>
            Welcome to Best Buy! We are dedicated to providing you with the best shopping experience.
      ...
      <Row className="mt-5">
        <Col md={12}>
          <h3>Our History</h3>
          <p>
            Founded in 2015, Best Buy started with a simple ideas to make online shopping convenient
            and accessible for everyone. Over the years, we have grown from a small startup to a
            reputable online retailer with a vast range of products and a loyal customer base with 24x7 support over calls and emails.
          </p>
        </Col>
      </Row>
      ...
      <Row className="mt-5">
        <Col md={12}>
          ...
          <blockquote className="blockquote">
            <p>"Best Buy has transformed my shopping experience. The quality of products is unmatched!"</p>
            <footer className="blockquote-footer">Jhonny, <cite title="Source Title">Satisfied Customer</cite></footer>
          </blockquote>
          <blockquote className="blockquote">
            <p>"I love the variety and the fast delivery. My go-to place for online shopping! They provide good range of products.."</p>
            <footer className="blockquote-footer">Bravo, <cite title="Source Title">Happy Shopper</cite></footer>
          </blockquote>
        </Col>
      </Row>
      ...
      <Row className="mt-5">
        <Col md={12}>
          ...
          <p>We accept all major credit cards, PayPal, Cash on Delivery, and other secure payment methods.</p>
          ...
          <h5>4. What is your replace policy?</h5>
          <p>We have a 7-day replacement policy for unused products. Please visit our replacement policy page for more details.</p>
        </Col>
      </Row>
    </Container>
  );
